...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MaritalStatus.gender'
        db.delete_column(u'main_maritalstatus', 'gender_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MaritalStatus.gender'
        raise RuntimeError("Cannot reverse this migration. 'MaritalStatus.gender' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MaritalStatus.gender'
        db.add_column(u'main_maritalstatus', 'gender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='marital_status_gender', to=orm['main.Gender']),
                      keep_default=False)
