...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopBanner.link'
        db.add_column(u'main_topbanner', 'link',
                      self.gf('django.db.models.fields.URLField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'RightBanner.link'
        db.add_column(u'main_rightbanner', 'link',
                      self.gf('django.db.models.fields.URLField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'MiddleBanner.link'
        db.add_column(u'main_middlebanner', 'link',
                      self.gf('django.db.models.fields.URLField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopBanner.link'
        db.delete_column(u'main_topbanner', 'link')

        # Deleting field 'RightBanner.link'
        db.delete_column(u'main_rightbanner', 'link')

        # Deleting field 'MiddleBanner.link'
        db.delete_column(u'main_middlebanner', 'link')
