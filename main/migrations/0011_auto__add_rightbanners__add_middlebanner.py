...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MiddleBanner'
        db.create_table(u'main_middlebanner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['MiddleBanner'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MiddleBanner'
        db.delete_table(u'main_middlebanner')
