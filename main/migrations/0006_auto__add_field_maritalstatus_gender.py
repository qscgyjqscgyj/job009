...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaritalStatus.gender'
        db.add_column(u'main_maritalstatus', 'gender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='marital_status_gender', to=orm['main.Gender']),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.maritalstatus': {
            ...
            'gender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'marital_status_gender'", 'to': u"orm['main.Gender']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
        u'main.position': {
