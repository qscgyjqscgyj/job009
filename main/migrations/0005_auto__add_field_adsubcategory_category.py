...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdSubCategory.category'
        db.add_column(u'main_adsubcategory', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ad_sub_category_category', to=orm['main.AdCategory']),
                      keep_default=False)

        # Removing M2M table for field subcategory on 'AdCategory'
        db.delete_table(db.shorten_name(u'main_adcategory_subcategory'))


    def backwards(self, orm):
        # Deleting field 'AdSubCategory.category'
        db.delete_column(u'main_adsubcategory', 'category_id')

        # Adding M2M table for field subcategory on 'AdCategory'
        m2m_table_name = db.shorten_name(u'main_adcategory_subcategory')
        ...
        db.create_unique(m2m_table_name, ['adcategory_id', 'adsubcategory_id'])
