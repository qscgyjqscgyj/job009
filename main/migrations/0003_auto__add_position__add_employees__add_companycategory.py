...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_position', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'main', ['Position'])

        # Adding model 'Employees'
        db.create_table(u'main_employees', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'main', ['Employees'])

        # Adding model 'CompanyCategory'
        db.create_table(u'main_companycategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'main', ['CompanyCategory'])


    def backwards(self, orm):
        # Deleting model 'Position'
        db.delete_table(u'main_position')

        # Deleting model 'Employees'
        db.delete_table(u'main_employees')

        # Deleting model 'CompanyCategory'
        db.delete_table(u'main_companycategory')
