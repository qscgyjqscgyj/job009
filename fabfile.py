...
from job009.settings import LOCAL_APPS

env.hosts = ['job009@job009.ru:22']
prefix = prefix('source /home/job009/bin/activate')

def deploy():
    with cd('/home/job009/site/job009'):
        with prefix:
