...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resume.date'
        db.alter_column(u'resume_resume', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Resume.date'
        db.alter_column(u'resume_resume', 'date', self.gf('django.db.models.fields.DateTimeField')())
