...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Resume.smoke'
        db.delete_column(u'resume_resume', 'smoke')


        # Changing field 'Resume.business_trip'
        db.alter_column(u'resume_resume', 'business_trip', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Adding field 'Resume.smoke'
        db.add_column(u'resume_resume', 'smoke',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Resume.business_trip'
        db.alter_column(u'resume_resume', 'business_trip', self.gf('django.db.models.fields.NullBooleanField')(null=True))
