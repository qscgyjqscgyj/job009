...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resume.move'
        db.alter_column(u'resume_resume', 'move', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Resume.move'
        db.alter_column(u'resume_resume', 'move', self.gf('django.db.models.fields.NullBooleanField')(null=True))
