...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'resume_resume', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.CustomApplicant'], null=True))

    def backwards(self, orm):

        # Changing field 'Resume.owner'
        db.alter_column(u'resume_resume', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
