...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resume.subcategory'
        db.add_column(u'resume_resume', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='resume_subcategory', to=orm['main.AdSubCategory']),
                      keep_default=False)
    ...
    models = {
        ...
        u'resume.resume': {
            ...
            'subcategory': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resume_subcategory'", 'to': u"orm['main.AdSubCategory']"}),
