...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Resume.subcategory'
        db.delete_column(u'resume_resume', 'subcategory_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Resume.subcategory'
        raise RuntimeError("Cannot reverse this migration. 'Resume.subcategory' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Resume.subcategory'
        db.add_column(u'resume_resume', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_subcategory', to=orm['main.AdSubCategory']),
                      keep_default=False)
