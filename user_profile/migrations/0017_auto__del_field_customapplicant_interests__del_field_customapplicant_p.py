...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomApplicant.interests'
        db.delete_column(u'user_profile_customapplicant', 'interests')

        # Deleting field 'CustomApplicant.professional_goals'
        db.delete_column(u'user_profile_customapplicant', 'professional_goals')

        # Adding field 'CustomApplicant.institution'
        db.add_column(u'user_profile_customapplicant', 'institution',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomApplicant.diploma'
        db.add_column(u'user_profile_customapplicant', 'diploma',
                      self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomApplicant.ex_education'
        db.add_column(u'user_profile_customapplicant', 'ex_education',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CustomApplicant.interests'
        db.add_column(u'user_profile_customapplicant', 'interests',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomApplicant.professional_goals'
        db.add_column(u'user_profile_customapplicant', 'professional_goals',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CustomApplicant.institution'
        db.delete_column(u'user_profile_customapplicant', 'institution')

        # Deleting field 'CustomApplicant.diploma'
        db.delete_column(u'user_profile_customapplicant', 'diploma')

        # Deleting field 'CustomApplicant.ex_education'
        db.delete_column(u'user_profile_customapplicant', 'ex_education')
    ...
    models = {
        ...
        u'user_profile.customapplicant': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.City']", 'null': 'True', 'blank': 'True'}),
            'diploma': ('django.db.models.fields.TextField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
