...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomEmployer.about'
        db.add_column(u'user_profile_customemployer', 'about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomEmployer.about'
        db.delete_column(u'user_profile_customemployer', 'about')
