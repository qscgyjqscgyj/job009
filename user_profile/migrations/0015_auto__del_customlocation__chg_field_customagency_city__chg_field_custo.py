...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomAgency.city'
        db.alter_column(u'user_profile_customagency', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.City'], null=True))

        # Changing field 'CustomApplicant.city'
        db.alter_column(u'user_profile_customapplicant', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.City'], null=True))

        # Changing field 'CustomEmployer.city'
        db.alter_column(u'user_profile_customemployer', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.City'], null=True))

    def backwards(self, orm):
        # Adding model 'CustomLocation'
        db.create_table(u'user_profile_customlocation', (
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(related_name='custom_location_city', to=orm['django_geoip.City'])),
        ...
        # Changing field 'CustomAgency.city'
        db.alter_column(u'user_profile_customagency', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_geoip.City'], null=True))
        ...
        # Changing field 'CustomEmployer.city'
        db.alter_column(u'user_profile_customemployer', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_geoip.City'], null=True))
