...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomApplicant.diploma'
        db.alter_column(u'user_profile_customapplicant', 'diploma', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'CustomApplicant.diploma'
        db.alter_column(u'user_profile_customapplicant', 'diploma', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))
