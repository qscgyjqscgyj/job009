...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomEmployer.phone_details'
        db.add_column(u'user_profile_customemployer', 'phone_details',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomEmployer.phone_details'
        db.delete_column(u'user_profile_customemployer', 'phone_details')
