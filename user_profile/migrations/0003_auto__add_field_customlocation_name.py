...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomLocation.name'
        db.add_column(u'user_profile_customlocation', 'name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 10, 1, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomLocation.name'
        db.delete_column(u'user_profile_customlocation', 'name')
