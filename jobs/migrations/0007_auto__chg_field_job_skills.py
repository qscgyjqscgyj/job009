...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.skills'
        db.alter_column(u'jobs_job', 'skills', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.skills'
        raise RuntimeError("Cannot reverse this migration. 'Job.skills' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Job.skills'
        db.alter_column(u'jobs_job', 'skills', self.gf('django.db.models.fields.TextField')())
