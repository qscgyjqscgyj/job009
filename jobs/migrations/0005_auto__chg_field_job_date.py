...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.date'
        db.alter_column(u'jobs_job', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Job.date'
        db.alter_column(u'jobs_job', 'date', self.gf('django.db.models.fields.DateTimeField')())
