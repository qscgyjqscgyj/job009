...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.city'
        db.alter_column(u'jobs_job', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.City']))

    def backwards(self, orm):

        # Changing field 'Job.city'
        db.alter_column(u'jobs_job', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_geoip.City']))
