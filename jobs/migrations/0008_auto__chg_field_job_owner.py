...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'jobs_job', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.CustomEmployer'], null=True))

    def backwards(self, orm):

        # Changing field 'Job.owner'
        db.alter_column(u'jobs_job', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'jobs.job': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_city'", 'to': u"orm['main.City']"}),
            ...
            'move_cities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['main.City']", 'null': 'True', 'blank': 'True'}),
            'office': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user_profile.CustomEmployer']", 'null': 'True', 'blank': 'True'}),
            ...
            'subcategory': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'job_subcategory'", 'symmetrical': 'False', 'to': u"orm['main.AdSubCategory']"})
        },
        u'main.adarea': {
