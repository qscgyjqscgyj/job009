...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subcategory on 'Job'
        m2m_table_name = db.shorten_name(u'jobs_job_subcategory')
        ...
        db.create_unique(m2m_table_name, ['job_id', 'adsubcategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field subcategory on 'Job'
        db.delete_table(db.shorten_name(u'jobs_job_subcategory'))
